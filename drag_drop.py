    ...
    while run:
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if DRAGGING:
                    DRAGGING = False
                    for recycle_bin_rect in RECYCLE_BINS_RECT_LIST:
                        if recycle_bin_rect.colliderect(DRAGGED_ITEM['rect']) and \
                        RECYCLE_BINS_RECT_LIST[DRAGGED_ITEM].colliderect(DRAGGED_ITEM['rect']):
