...
def start_menu(screen):
    background = pygame.image.load("background_image.jpeg") # Replace "background_image.jpeg" with the filename of your background image
    font = pygame.font.Font(None, 50)
    start_text = font.render("Click to Start Game", True, (255, 255, 255))
    ...
    while True:
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                game_loop # Replace "game_loop" with the name of the game loop function
...
def main():
    ...
    while run:
        ...
        # Call the start_menu() function and pass the screen variable
        start_menu(screen)
