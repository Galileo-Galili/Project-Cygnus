...
class TestRecycleRush(unittest.TestCase):
    def test_create_trash_item(self):
        trash_type = "paper"
        image = pygame.image.load('Assets/Paper1.png')
    ...
    def test_create_recycle_bin(self):
        bin_type = "glass"
        image = pygame.image.load('Assets/GlassBin.png')
    ...
    def test_check_collision(self):
        game = RecycleRush()
        trash_type = "paper"
        image = pygame.image.load('Assets/Paper2.png')
        item = TrashItem(trash_type, image)
    ...
    def test_update_trash_item(self):
        trash_type = "plastic"
        image = pygame.image.load('Assets/Plastic3.png')
        item = TrashItem(trash_type, image)
